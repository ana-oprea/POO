...
Drona::Drona(const string firma, char* model):idDrona(idContor++){
    this->firma = firma;
...
Drona::Drona(const string firma, char* model, float pret,
            ...
            float* dimensiuni, char* greutate, int distantaZborMin, int distantaZborMax, int nrElice):idDrona(idContor++){
...
Drona::Drona(const Drona& drona):idDrona(idContor){
