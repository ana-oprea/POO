...
AparatFoto::AparatFoto():idAparat(idContor++){
    this->model = NULL;
...
AparatFoto::AparatFoto(const float pret):idAparat(idContor++){
    this->pret = pret;
    this->model = NULL;
    this->dimensiuni = NULL;
    this->firma = "";
...
AparatFoto::AparatFoto(const string firma, char* model):idAparat(idContor++){
    this->firma = firma;
...
AparatFoto::AparatFoto(const AparatFoto& aparat):idAparat(idContor){
    if (aparat.firma != "")
